...
exports.run = async (client, message, args) => {
  ...
  if (!toSecond || toSecond == undefined) return message.channel.send("<a:b_no:721969465205588048> | Please insert the valid time format!");
  
  if (toSecond > 21600) return message.channel.send("<a:b_no:721969465205588048> | Timer should be less than or equal to 6 hours.");
